...
class TestStockPickingPutInPackRestriction(SavepointCase):
    ...
    def test_put_in_pack_no_restriction(self):
        """ """
        self.picking.picking_type_id.put_in_pack_restriction = False
        res = self.picking.action_put_in_pack()
        self.assertEqual(res._name, "stock.quant.package")

    def test_put_in_pack_package_not_allowed(self):
        """ """
        self.picking.picking_type_id.put_in_pack_restriction = "no_package"
    ...
    def test_picking_done_breaks_restriction_with_package(self):
        ...
        # TODO check it is the correct error
        with self.assertRaises(ValidationError):
